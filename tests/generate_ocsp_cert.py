DESCRIPTION = "Generate OCSP Responder Certificate"
...
print("Generate OCSP responder certificate")
...
with open("config/cert_templates/ocsp_responder_cert_template.json", "r") as template_file:
    template_json = template_file.read()
certificate.load_certificate_template(template_json=template_json)

request_json = '''{
    "subject_name": {
        "commonName": "IoT Root CA OCSP"
    }
}
'''
...
with open("out/ocsp_private_key.pem", "wb") as key_file:
...
with open("out/ocsp_certificate.pem", "wb") as cert_file:
    cert_file.write(certificate_pem)

print("OCSP certificate generated successfully.")
